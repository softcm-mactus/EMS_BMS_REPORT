...
Public Class WirelessCDUDeviceBatteryPercentage
    ...
    Private Sub LoadReportsCombo(ByRef nGoupID As Integer)
        ...
        Try
            sQuery = "SELECT * FROM TBL_ReportsConfiguration WHERE AlmGroupID=" + nGoupID.ToString() + " AND ReportType=" + Str(ReportType.BatteryStatusReport)
    ...
    Protected Sub bGenerateReport_Click(sender As Object, e As EventArgs) Handles bGenerateReport.Click
        ...
        Try
            ...
            nInterval = Convert.ToInt32(cTimeInterval.SelectedItem.Value)
