<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DataTrendReport.aspx.vb" Inherits="MactusReportWeb.DataTrendReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Generate Data Trend Report</title>
</head>
<body>
    <form id="form1" runat="server">
        <div style="text-align: center">
            <asp:Label ID="Label1" runat="server" Text="Generate Data Trend Report" Font-Size="XX-Large" Font-Bold="True" Font-Underline="True"></asp:Label>
        </div>
