...
Public Class ExcursionReport
    ...
    Private Sub LoadReportsCombo(ByRef nGoupID As Integer)
        ...
        Try
            sQuery = "SELECT * FROM TBL_ReportsConfiguration WHERE AlmGroupID=" + nGoupID.ToString() + " AND ReportType=" + Str(ReportType.ExcursionReport)
