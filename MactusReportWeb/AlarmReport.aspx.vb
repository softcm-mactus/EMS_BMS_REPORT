...
Public Class AlarmReport
    ...
    Protected Sub bGenerateReport_Click(sender As Object, e As EventArgs) Handles bGenerateReport.Click
        ...
        If g_dbType = DBType.EBODB Then
            nReportStatusID = InsertNewReportStatusRecord(ReportType.AlarmReport, nReportID, g_isEBOGMTTime, oFromDate, oToDate, nInterval, m_sUserName, ReportType.AlarmReport)
        Else
            nReportStatusID = InsertNewReportStatusRecord(ReportType.AlarmReport, nReportID, g_isColGMTTime, oFromDate, oToDate, nInterval, m_sUserName, ReportType.AlarmReport)
        End If
