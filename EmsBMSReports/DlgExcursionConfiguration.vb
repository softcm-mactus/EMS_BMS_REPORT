...
Public Class DlgExcursionConfiguration
        ...
        Try
            ...
            Using oConnection As New OdbcConnection(g_sConString)
                ...
                While oReader.Read()
                    ...
                    If nReportType = MactusReportLib.ReportType.DataTrendAlarmReport Then
                        nRow = oGrid.Rows.Add()
    ...
    Private Sub bAddNewReport_Click(sender As Object, e As EventArgs) Handles bAddNewReport.Click
        ...
        If oDlg.ShowDialog() = DialogResult.OK Then
            ...
            Using oConnection As New OdbcConnection(g_sConString)
                ...
                oCmd.Parameters.Add("@1", OdbcType.Int).Value = MactusReportLib.ReportType.DataTrendAlarmReport  'reporttype
